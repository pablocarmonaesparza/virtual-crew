      ...
      >
        ...
        <div className="flex h-16 items-center justify-between px-4 border-b border-border/30">
          <div className="flex items-center gap-2">
            <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-[#1a2b4a] dark:bg-primary/20">
              <span className="text-xs font-bold text-white dark:text-primary">EXL</span>
            </div>
            {isSidebarOpen && (
              <span className="font-semibold text-[#1a2b4a] dark:text-foreground truncate">
                ADM S&OP
              </span>
            )}
          </div>
