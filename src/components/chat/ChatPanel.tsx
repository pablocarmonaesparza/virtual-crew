...
export function ChatPanel() {
  ...
  return (
    <Card className="fixed bottom-4 right-2 left-2 sm:left-auto sm:right-4 z-50 w-auto sm:w-[400px] max-h-[70vh] sm:max-h-[600px] shadow-2xl flex flex-col">
      ...
      <CardContent className="flex-1 p-0 flex flex-col min-h-0">
        <div ref={scrollRef} className="flex-1 overflow-y-auto p-4 space-y-4 max-h-[300px] sm:max-h-[420px]">
          ...
          {chatMessages.map((msg) => (
            ...
            >
              ...
              <div
                className={`rounded-lg px-3 py-2 text-sm max-w-[85%] sm:max-w-[75%] break-words ${
                  msg.role === "user"
